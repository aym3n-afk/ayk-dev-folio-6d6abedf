      ...
      <div className="max-w-7xl mx-auto container-padding">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            A comprehensive overview of my technical expertise across embedded systems, 
            software development, and advanced engineering tools
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20">
              ...
              <div className="text-sm text-muted-foreground mb-3">5+ Years</div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-accent/5 to-accent/10 border border-accent/20">
              ...
              <div className="text-sm text-muted-foreground mb-3">3-5 Years</div>
              <div className="flex flex-wrap gap-1 justify-center">
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-secondary/5 to-secondary/10 border border-secondary/20">
              <div className="text-3xl font-bold text-muted-foreground mb-2">Intermediate</div>
              <div className="text-sm text-muted-foreground mb-3">1-3 Years</div>
              <div className="flex flex-wrap gap-1 justify-center">
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-warning/5 to-warning/10 border border-warning/20">
              <div className="text-3xl font-bold text-warning mb-2">Learning</div>
              <div className="text-sm text-muted-foreground mb-3">&lt; 1 Year</div>
              <div className="flex flex-wrap gap-1 justify-center">
